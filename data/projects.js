...
const PROJECTS = [
  ...
  },
  {
    ...
    role: "Récupération des données avec des scripts Python, puis réalisation des graphiques sur Grafana.",
    role_en: "Collected the data with Python scripts, then built the charts in Grafana.",
  ...
  },
  {
    ...
    role: "Récupération des données en Python, et script qui génère les prompts envoyés aux deux IA du projet.",
    role_en: "Data collection in Python, and the script that generates the prompts sent to the project's two AIs.",
  ...
  },
  {
    ...
    role: "L'idée initiale du projet, et toute la direction artistique / identité visuelle.",
    role_en: "The project's original idea, and all of its art direction / visual identity.",
  ...
  },
  {
    ...
    role: "Principalement le front-end, ainsi que la partie back-end liée au CRUD.",
    role_en: "Mainly the front-end, plus the CRUD part of the back-end.",
  ...
  },
  {
    ...
    role: "Le front-end et la partie back-end / CRUD.",
    role_en: "The front-end and the back-end / CRUD part.",
  ...
  },
  {
    ...
    role: "Tout le développement, notamment toute l'algorithmie derrière le jeu.",
    role_en: "All of the development, including all the algorithms behind the game.",
    team: 'solo',
  ...
  },
  {
    ...
    role: "Principalement l'algorithmie : les algorithmes de génération et de résolution.",
    role_en: "Mainly the algorithms: the generation and solving algorithms.",
